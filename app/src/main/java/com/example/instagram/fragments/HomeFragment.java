...
import com.example.instagram.adapters.AdapterFeeds;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.recyclerFeeds);
    ...
    private void recuperarFeed() {
        feedRef = FirebaseInstance.instanceDatabase().child("usuarios")
                .child(UsuarioFirebase.dadosUsuario().getId()).child("feeds");

        eventListener = feedRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapterFeeds = new AdapterFeeds(listFeed, getActivity());
